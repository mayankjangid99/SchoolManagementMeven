...
<c:if test="${empty sessionScope.SessionManager }">
      <div class="content-wrapper" style="width: 100%; margin-left: 0px;">
        ...
        <section class="content">
          ...
          <div class="error-page col-xs-12 text-center">
          	<img src="${pageContext.request.contextPath}/static/img/access-denied.png" style="margin-left: 60%;" />
            <h2 class="headline text-yellow" style="font-size: 70px; margin-left: 80%; margin-top: 5%;"> 403</h2>
