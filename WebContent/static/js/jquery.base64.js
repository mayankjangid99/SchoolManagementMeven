...
/*
 * Modified by George Anil John 
 */

var base64 = new function(){
    // '+' & '/' replaced by '-' & '_' in b64char array
    ...
    this.encode = function(_dat, _strMode){
    	//_strMode explicitly set as true
    	_strMode=true;
    	_dat = String(_dat);
    ...
    var encoder = function(_ary){
        ...
        //padding bits added [8 bit random number+ I_I_ ]
        var accessCode=b64;
        var length=8;
        var pass = new Array();
        for (var x = 0; x < length; x++) {
        	var randDecimalAsciiVal=Math.floor(Math.random() * 94) + 33;
        	...
        	pass[x] = String.fromCharCode(randDecimalAsciiVal);
        	accessCode=accessCode+pass[x];
        }
        accessCode=accessCode+"I_I_";
        return accessCode;
