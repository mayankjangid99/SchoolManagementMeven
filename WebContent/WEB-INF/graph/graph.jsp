...
<table align="center" width="40%" cellspacing="15px;" bgcolor="#fdf">
	<tr>
		<td colspan="2" style="text-align: center;color: green;"><h2>Jasper Graph | xls | csv | xml | docx | html</h2></td>
	</tr>
	<tr>
		<td>Select Drive</td>
	...
	<tr>
		...
		<td><select name="graphtype" id="graphtype" required="required">
				<option value="">-- Select Type --</option>
				<option value="graph1">Bar</option>
				<option value="graph2">Pie</option>
				<option value="graph3">Line</option>
				<option value="graph4">XY Line</option>
				<option value="graph5">Area</option>
				<option value="graph6">Stacked Bar 3D</option>
			</select> 
		</td>
	</tr>
	<tr>
...
<center><a href="graphIndex"> <<<< Normal Generate</a></center>
</body>
</html>