...
<div class="content-wrapper" style="min-height: 1066px;">
	...
	<section class="content-header">
		<h1>
			Search Student Report Card <!-- <small>it all starts here</small> -->
		</h1>
	</section>
		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="col-md-6 pull-right">
					<a href="selectClassSectionModal?action=addStudentReportCard" data-app-proj-role="modal-link" class="btn btn-primary pull-right">Add Student Report Card</a>
				</div>
			</div>
