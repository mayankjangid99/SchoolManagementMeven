...
<div class="appModalBody">
	<div class="modal fade app-modal-primary" id="myModall">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">Result Fee</h4>
				</div>
				<div class="modal-body">
					...
					<div class="col-md-12">
						<div class="col-md-3"><label>Paid Amount <span class="red">*</span></label></div>
						<div class="col-md-8">
							<div class="form-group has-feedback">
...
<div class="content-wrapper" style="min-height: 1066px;">
	...
	<section class="content-header">
		<h1>
			Result Student Fee Details <!-- <small>it all starts here</small> -->
		</h1>
	</section>
							...
							<div class="col-md-3">
								<h3 class="box-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" class="collapsed">
										<i class="fa fa-calendar"></i>&nbsp;&nbsp; Yearly
									</a>
								</h3>
							</div>
							<div class="col-md-3">
...
<c:if test="${userProfile.getUserRoleId() ne 'ROLE_USER'}">
	...
	<%findFlagYr = true; %>			<div style="display: none;">
									...
									<div class="col-md-3 amountPaid">
										<a class="btnn yearly" data-toggle="modal" data-target="#myModal" >${StudentFeeDetails.amountPaid }</a>
									</div>
						...
						<div class="box-header">
							<h3 class="box-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed" aria-expanded="false">
									<i class="fa fa-calendar"></i>&nbsp;&nbsp; Half-Yearly
								</a>
							</h3>
						</div>
						<div class="col-md-3">
...
<c:if test="${userProfile.getUserRoleId() ne 'ROLE_USER'}"> 
	...
	<c:if test="${StudentFeeDetails.feeCategoryCode eq halfFeeCategory.feeCategory.feeCategoryCode }">
									<div class="col-md-3 amountPaid">
										<a class="btnn halfYearly" data-toggle="modal" data-target="#myModal" >${StudentFeeDetails.amountPaid }</a>
									</div>
									<div class="col-md-3 amountDue">
										${StudentFeeDetails.amountDue }
									</div>
...
<c:forEach var="monthlyFeeCategory" items="${monthlyFeeCategories }">
	...
	%>
									...
									<div class="col-md-3 amountPaid">
										<a class="btnn monthly" data-toggle="modal" data-target="#myModal" >${StudentFeeDetails.amountPaid }</a>
									</div>
									<div class="col-md-3 amountDue">
										${StudentFeeDetails.amountDue }
									</div>
...
// $('input, select, textarea').attr('disabled', 'disabled');
	...
	$('[data-toggle="modal"]').on('click', function(){
		...
		var boxTitle = $(parentEle).find('.box-title:first').text();
		...
		if($(this).text().trim() != "+"){
			$('[name="amountDue"]').val($(this).text().trim());
		}
		var typeName = '';
	...
	$('.generateFeeReport').on('click', function(){
		...
		/* $.ajax({
	        ...
	        data: "receiptNo="+$(this).attr('data-receipt-no')+"&admissionNo="+$('[name="admissionNo"]').val()+"&rollNo="+$('[name="rollNo"]').val()+"&classCode="+$('[name="classCode"]').val()+"&sectionCode="+$('[name="sectionCode"]').val()+"&type="+feeCategoryType,
	        //dataType: 'json',
	        success: function (data) {
	        	console.log(data);
