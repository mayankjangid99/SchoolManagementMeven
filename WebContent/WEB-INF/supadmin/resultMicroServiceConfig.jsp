...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Micro Service Config <small>Micro Service Config Information</small>
		</h1>
		<!-- <ol class="breadcrumb">
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            var source = {
                ...
                url: "fetchMicroServiceConfig?configCode=${param.configCode}"
            };
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
						  { text: 'Code', datafield: 'configCode', width: 270 },
                          { text: 'Value', datafield: 'configValue', width: 350},
                          { text: 'Description', datafield: 'configDescription', width: 485},
...
var navigateTo = function(action, fieldVal) {
	...
	if(action == "Edit") {
		url = "editMicroServiceConfig";
	} else if(action == "View") {
		url = "viewMicroServiceConfig";
	}
