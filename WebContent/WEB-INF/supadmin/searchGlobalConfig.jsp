...
<div class="content-wrapper" style="min-height: 1066px;">
	...
	<section class="content-header">
		<h1>
			Search Global Config <!-- <small>it all starts here</small> -->
		</h1>
	</section>
...
<%@ include file="../common/message.jsp" %>
	...
	<section class="content">
		<div class="box box-primary">
			...
			<form role="form" action="resultGlobalConfig" method="post" class="form">
				<div class="box-body">
					<div class="col-md-6">
						<div class="col-md-8">
							<div class="form-group">
								<label>Global Config <!-- <span class="red">*</span> --></label> 
								<!-- <input type="text"
									class="form-control" placeholder="Global Config Code"
