            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">${userProfile.getFullname()}</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
	                ...
	                <img src="${pageContext.request.contextPath}/static/img/profile.png" class="img-circle" alt="User Image" />
              		...
              		<p>
                      ${userProfile.getUsername()} - Web Developer
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
<%--                       <a href="viewUser?userId=${userProfile.getUserId()}" class="spr btn btn-default btn-flat">Profile</a> --%>
                      <a href="viewUser?encUserId=${userProfile.encUserId}" class="spr btn btn-default btn-flat getme" data-type="${userProfile.getUserId()}">Profile</a>
                    </div>
