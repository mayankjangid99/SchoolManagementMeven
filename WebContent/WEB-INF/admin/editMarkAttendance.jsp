...
<div class="content-wrapper" style="min-height: 1066px;">
	...
	<section class="content-header">
		<h1>
			Edit Marked Attendance <!-- <small>it all starts here</small> -->
		</h1>
	</section>
...
<%-- 				</c:if> --%>
			...
			<form action="updateMarkAttendance" method="post">
				...
				<div class="box-body">
					<div class="col-sm-12">
				        ...
				        <div class="col-md-3">
							...
							<div class="switch">
					            <input id="SMS_STUDENT_ATTENDANCE" name="smsStudentAttendance" value="N" class="cmn-toggle cmn-toggle-round-small" type="checkbox" />
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									<input type='text' class="form-control" name="date" required="required" readonly="readonly" value="${param.date }" placeholder="dd-mm-yyyy" />
...
<c:forEach var="student" items="${StudentMap }">
											<tr role="row" class="odd">
												...
												<td>${student['sName'] }</td>
												<td>${student['fName'] }
													<input type="hidden" name="fatherEmail" value="${student['fEmail'] }">
													<input type="hidden" name="fatherMobile" value="${student['fMobile'] }">
												</td>
...
<%-- 												<label class="attendance_status btn abtn btn-info round">${student['attendance'] }</label> --%>
												...
												<c:if test="${student['sms'] eq 'Y' }">
													<label class="sms_status btn abtn btn-info round">${student['sms'] }</label>
												</c:if>
												<c:if test="${student['sms'] eq 'N' }">
													<label class="sms_status btn abtn btn-info2 round">${student['sms'] }</label>
												</c:if>
												<c:if test="${student['sms'] eq null }">
													<label class="sms_status btn btn-info2 round">No data</label>${student['sms'] }
												</c:if>
<!-- 												<label class="sms_status btn abtn btn-info round">Y</label>  -->
												...
												<c:if test="${student['email'] eq 'Y' }">
													<label class="email_status btn abtn btn-info round">${student['email'] }</label>
												</c:if>
												<c:if test="${student['email'] eq 'N' }">
													<label class="email_status btn abtn btn-info2 round">${student['email'] }</label>
												</c:if>
												<c:if test="${student['email'] eq null }">
													<label class="email_status btn btn-info2 round">No data</label>
												</c:if>
