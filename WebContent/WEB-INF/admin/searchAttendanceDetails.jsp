...
<div class="content-wrapper" style="min-height: 1066px;">
	...
	<section class="content-header">
		<h1>
			Search Mark Attendance <!-- <small>it all starts here</small> -->
		</h1>
	</section>
	...
	<section class="content">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title">Search Attendance Details</h3>
				<div class="col-md-6 pull-right">
					<a href="searchMarkAttendance" class="btn btn-primary pull-right">Mark Attendance</a>
